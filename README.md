...
- Contract-driven health and shared models via `architect-career-ai-contracts`
...
- Not a CRUD app
- Not domain business endpoints
- Not RAG/agent/prompt implementations (extension points only)
